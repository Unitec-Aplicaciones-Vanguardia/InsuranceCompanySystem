...
{
    public class HouseRater : Rater
    {
        public HouseRater(ILogger logger)
            : base(logger)
        {
        }
        ...
        {
            Logger.Log("Rating house policy...");
            Logger.Log("Validating policy.");
            if (policy.BondAmount == 0 || policy.Valuation == 0)
            {
                Logger.Log("House policy must specify Bond Amount and Valuation.");
                return 0m;
            }
